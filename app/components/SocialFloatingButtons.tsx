...
export default function SocialFloatingButtons() {
  const phoneNumber = "50212345678"; // Sustituye por tu número real de GT
  const message = encodeURIComponent(
    "¡Hola! Estoy interesado en reservar o solicitar más información sobre las expediciones."
  );

  const whatsappUrl = `https://wa.me/${phoneNumber}?text=${message}`;
  const instagramUrl = "https://instagram.com/TU_USUARIO_DE_INSTAGRAM"; // Sustituye por tu usuario
